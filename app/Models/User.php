...
#[Fillable(['name', 'email', 'password', 'last_login_at', 'terms_accepted_at', 'marketing_emails_opt_in', 'signup_country_code', 'signup_country_name', 'signup_latitude', 'signup_longitude'])]
