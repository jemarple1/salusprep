...
@section('content')
    <div class="mb-8">
        ...
        <p class="mt-2 max-w-2xl text-slate-400">
            Hands-on scenarios for SOAP charting, triage, GCS, burns, stroke scales, vitals, and more. The first scenario in each exercise is free.
        </p>
    </div>
    ...
    @if ($exercises !== [])
        <x-exercise-grid
            :exercises="$exercises"
            title="All exercises"
            :description="'Try scenario 1 free in each exercise. Unlock '.$sectionLabel.' for every scenario, unlimited quizzes, and flashcards.'"
        />
    @else
